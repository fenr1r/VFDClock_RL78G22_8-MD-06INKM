...
/*
    Serial Standby Control Register 0 (SSC0L)
*/
/* Selection of enable or disable the generation of communication error interrupts in the SNOOZE mode (SSEC0) */
#define _00_SAU_CH0_SNOOZE_INT_ENABLE    (0x00U)    /* enable the generation of error interrupts (INTSRE0) */
#define _02_SAU_CH0_SNOOZE_INT_DISABLE   (0x02U)    /* disable the generation of error interrupts (INTSRE0) */
/* Setting of the SNOOZE mode (SWC0) */
#define _00_SAU_CH0_SNOOZE_OFF           (0x00U)    /* do not use the SNOOZE mode function */
#define _01_SAU_CH0_SNOOZE_ON            (0x01U)    /* use the SNOOZE mode function */
