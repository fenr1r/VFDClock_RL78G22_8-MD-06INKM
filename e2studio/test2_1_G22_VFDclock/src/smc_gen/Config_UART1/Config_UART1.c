...
void R_Config_UART1_Create(void)
{
    ...
    SPS0L = temp;
    ST0L_bit.no2 = 1U;    /* disable UART1 transmit */
    ST0L_bit.no3 = 1U;    /* disable UART1 receive */
    ...
    NFEN0_bit.no2 = 1U;     /* RXD1 noise filter on */
    SIR03L = _04_SAU_SIRMN_FECTMN | _02_SAU_SIRMN_PECTMN | _01_SAU_SIRMN_OVCTMN;    /* clear error flag */
    ...
    SOL0L |= _00_SAU_CHANNEL2_NORMAL;    /* output level normal */
    SOE0L_bit.no2 = 1U;    /* enable UART1 output */
    /* Set TxD1 pin */
    PMCA0 &= 0xFEU;
    PMCT0 &= 0xFEU;
    P0 |= 0x01U;
...
void R_Config_UART1_Start(void)
{
    ...
    SOE0L_bit.no2 = 1U;    /* enable UART1 output */
    SS0L_bit.no2 = 1U; /* enable UART1 transmit */
    SS0L_bit.no3 = 1U; /* enable UART1 receive */
    STIF1 = 0U;    /* clear INTST1 interrupt flag */
    SRIF1 = 0U;    /* clear INTSR1 interrupt flag */
    SREIF1 = 0U;    /* clear INTSRE1 interrupt flag */
...
void R_Config_UART1_Stop(void)
{
    ...
    ST0L_bit.no2 = 1U; /* disable UART1 transmit */
    ST0L_bit.no3 = 1U; /* disable UART1 receive */
    SOE0L_bit.no2 = 0U;    /* disable UART1 output */
    STIF1 = 0U;    /* clear INTST1 interrupt flag */
    SRIF1 = 0U;    /* clear INTSR1 interrupt flag */
    SREIF1 = 0U;    /* clear INTSRE1 interrupt flag */
}
